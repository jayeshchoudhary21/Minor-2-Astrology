  ...
  return (
    <div >
      ...
      <div className="relative w-full h-screen ">
        ...
        <video
          className="fixed top-0 left-0 w-full h-full object-cover mt-[68px]"
          autoPlay
          muted
          loop
          playsInline
        >
          <source src='../../../public/assets/images/back.mp4.mp4' type="video/mp4" />
            ...
            <div className="container  mb-[150px]">
              <div className="row">
                <div className="col-md-12 zodic">
                  ...
                  <div className="col-md-5 cont2 mt[150px] mb-75 top-[90px]">
